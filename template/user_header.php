...
<div class="container-xxl position-relative p-0" >
            <nav href="index.php" style="background-color:darkblue;" class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a class="navbar-brand p-0">
                    <h1 class="text-primary m-0"><img src="img/logo.png" alt="Logo" style="max-width: 20%; max-height: 20%; position:relative;">DishChord</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="logout.php" class="dropdown-item" style="color:#f47c01">Logout</a>
                            </div>
                        </div>
                </div>
            </nav>
